...
CREATE TABLE want_list (id BIGINT AUTO_INCREMENT, user_id BIGINT, producto_id BIGINT, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, PRIMARY KEY(id, user_id, producto_id)) ENGINE = INNODB;
...
ALTER TABLE want_list ADD CONSTRAINT want_list_producto_id_product_id FOREIGN KEY (producto_id) REFERENCES product(id);
